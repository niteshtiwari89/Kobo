...
import { getLibraryFormById } from '../api';

const PreviewLibraryForm = () => {
  ...
  useEffect(() => {
    const fetchTemplateDetails = async () => {
      try {
        setIsLoading(true);
        const fetchedTemplate = await getLibraryFormById(formId);
    ...
    return (
      <div className="flex justify-center items-center min-h-screen bg-gradient-to-br from-blue-50 to-blue-100">
        <div className="text-center">
          ...
          <p className="text-blue-800">Loading Form...</p>
        </div>
      </div>
    );
  }
    ...
    return (
      <div className="flex justify-center items-center min-h-screen bg-gradient-to-br from-red-50 to-red-100">
        <div className="text-center">
          ...
          <p className="text-red-800 text-xl">Form not found</p>
        </div>
      </div>
    );
  }
...
export default PreviewLibraryForm
